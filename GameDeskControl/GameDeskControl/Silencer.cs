...
namespace Sokoban.View.GameDocsComponents
{
    public class Silencer : DependencyObject
    {
        ...
        public static readonly DependencyProperty SilenceProperty = 
            
            DependencyProperty.RegisterAttached("Silence", typeof(bool), typeof(Silencer), new FrameworkPropertyMetadata
            {
                Inherits = true,
